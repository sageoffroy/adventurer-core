-- Adventurer Core maintenance update: universal class-10 chassis at 80%.
--
...
-- native WotLK classes and keeps 80% of it.
--
-- This is intentionally a new migration rather than rewriting
-- 003_adventurer_chassis.sql, so already-installed servers upgrade cleanly.
