...
class SpellDraftExternalConfigTests(unittest.TestCase):
    ...
    def test_level_ten_relationships_survive_externalization(self) -> None:
        ...
        combo_generators = "14:1|51:1|53:1|211:1|212:1"
        self.assertEqual(by_key["eviscerate"]["requires_any"], combo_generators)
        self.assertEqual(by_key["slice_and_dice"]["requires_any"], combo_generators)
